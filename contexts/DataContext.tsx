...
export interface DataContextType {
  ...
  returnAsset: (assetType: 'Device' | 'Sim', assetId: string, notes: string, adminName: string, returnedChecklist?: Record<string, boolean>, inactivateUser?: boolean, condition?: string, damageDescription?: string, evidenceFiles?: string[], isManual?: boolean, resolutionReason?: string) => void;
