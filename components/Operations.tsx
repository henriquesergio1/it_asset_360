                    ...
                    <div className="overflow-y-auto flex-1">
                        {filteredOptions.length > 0 ? filteredOptions.map(opt => (
                            <div 
                                ...
                                className={`px-4 py-3 cursor-pointer hover:bg-blue-50 dark:hover:bg-blue-900/30 border-b border-slate-50 dark:border-slate-700 last:border-0 ${value === opt.value ? 'bg-blue-50 dark:bg-blue-900' : ''}`}
                            >
              ...
              <div className="space-y-6">
                  <div className="flex items-center gap-4">
                      ...
                      <div className="flex gap-4">
                          <button onClick={() => { setAssetType('Device'); setSelectedAssetId(''); }} className={`flex-1 p-6 rounded-2xl border-2 transition-all flex flex-col items-center gap-3 ${assetType === 'Device' ? (activeTab === 'CHECKOUT' ? 'border-blue-600 bg-blue-50 dark:bg-blue-900 text-blue-700 dark:text-blue-400' : 'border-orange-600 bg-orange-50 dark:bg-orange-900 text-orange-700 dark:text-orange-400') : 'border-slate-100 dark:border-slate-800 hover:border-slate-200 dark:hover:border-slate-700 text-slate-500 dark:text-slate-300 bg-white dark:bg-slate-900'}`}>
                              <Smartphone size={32}/>
                              <span className="font-black uppercase text-[10px] tracking-widest">Dispositivo / Equipamento</span>
                          </button>
                          <button onClick={() => { setAssetType('Sim'); setSelectedAssetId(''); }} className={`flex-1 p-6 rounded-2xl border-2 transition-all flex flex-col items-center gap-3 ${assetType === 'Sim' ? (activeTab === 'CHECKOUT' ? 'border-blue-600 bg-blue-50 dark:bg-blue-900 text-blue-700 dark:text-blue-400' : 'border-orange-600 bg-orange-50 dark:bg-orange-900 text-orange-700 dark:text-orange-400') : 'border-slate-100 dark:border-slate-800 hover:border-slate-200 dark:hover:border-slate-700 text-slate-500 dark:text-slate-300 bg-white dark:bg-slate-900'}`}>
                              <Cpu size={32}/>
              ...
              {activeTab === 'CHECKOUT' && (
                  <div className="space-y-8 animate-fade-in">
                      <div className="space-y-6">
                        ...
                        />
                        <div className="flex items-center gap-3 p-4 bg-blue-50 dark:bg-blue-900 rounded-2xl border border-blue-100 dark:border-blue-900/40">
                            ...
                            <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-3">
                                {accessoryTypes.map(acc => (
                                    <button 
                                        ...
                                        className={`flex items-center gap-3 p-3 rounded-xl border-2 transition-all ${selectedAccessoryTypeIds.includes(acc.id) ? 'bg-blue-50 dark:bg-blue-900 border-blue-500 text-blue-900 dark:text-blue-100 shadow-sm' : 'bg-white dark:bg-slate-800 border-slate-100 dark:border-slate-700 text-slate-400 dark:text-slate-500 hover:border-slate-200 dark:hover:border-slate-600'}`}
                                    >
