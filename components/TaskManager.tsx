...
export const TaskManager: React.FC<TaskManagerProps> = ({ tasks, systemUsers, devices, models, assetTypes, onAddTask, onUpdateTask, currentUser, isAdmin }) => {
        ...
        <div className="overflow-x-auto shadow-inner">
          ...
          {filteredTasks.length > 0 ? (
            filteredTasks.map((task) => (
              <tr 
                key={task.id} 
                className={`group border-b border-slate-200 dark:border-slate-700/50 border-l-4 border-l-transparent hover:border-l-blue-600 dark:hover:border-l-sky-400 hover:bg-blue-50/60 dark:hover:bg-slate-700/60 transition-all cursor-pointer ${selectedTasksIds.includes(task.id) ? 'bg-blue-50/80 dark:bg-slate-700/80 border-l-blue-600' : ''}`}
 ...
 <div>
 <label className="block text-[11px] font-bold uppercase tracking-wider mb-1">Título</label>
 <input 
 required
 type="text"
 value={newTask.title}
 ...
 <div>
 <label className="block text-[11px] font-bold uppercase tracking-wider mb-1">Descrição</label>
 <textarea 
 ...
 <div>
 <label className="block text-[11px] font-bold uppercase tracking-wider mb-1">Manual / Passo a Passo (Instruções)</label>
 <textarea 
 ...
 <div>
 <label className="block text-xs font-bold uppercase tracking-wider mb-1">Tipo de Tarefa</label>
 <select 
 value={newTask.type}
 ...
 <div>
 <label className="block text-xs font-bold uppercase tracking-wider mb-1">Prazo</label>
 <input 
 ...
 <div>
 <label className="block text-xs font-bold uppercase tracking-wider mb-1">Atribuir a (Opcional)</label>
 <select 
 ...
 <button 
 type="submit"
 className="flex-1 py-3 bg-indigo-600 text-white rounded-xl font-bold hover:bg-indigo-700 transition-all shadow-indigo-200 shadow-none"
 >
 Criar Tarefa
 </button>
 </div>
 ...
 <div>
 <label className="block text-xs font-bold uppercase tracking-wider mb-2">Novo Status</label>
 ...
 <div>
 <label className="block text-xs font-bold uppercase tracking-wider mb-2">Novo Responsável</label>
 <select 
 value={bulkValue}
 ...
 disabled={!bulkValue}
 className="flex-1 py-3 bg-indigo-600 text-white rounded-xl font-bold hover:bg-indigo-700 transition-all shadow-indigo-200 shadow-none disabled:opacity-50"
 >
 Confirmar Alteração
 </button>
 </div>
