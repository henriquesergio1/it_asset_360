      ...
      {pendingTasks.length === 0 ? (
        ...
        pendingTasks.slice(0, 5).map(task => (
          <div 
            ...
            className="bg-slate-900/50 p-3 rounded-lg border border-indigo-900/30 flex items-center justify-between group hover:border-indigo-700 transition-all cursor-pointer"
          >
