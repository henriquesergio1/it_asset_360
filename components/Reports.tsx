...
const Reports = () => {
 ...
 <div>
 <h2 className="text-lg font-bold text-slate-100">Relatório de Colaboradores</h2>
 <p className="text-xs mt-1">Relação personalizável de colaboradores, linhas telefônicas e dispositivos.</p>
 </div>
