...
const RealService = {
    ...
    getSimulacaoPublica: (id: number | string): Promise<any> => apiRequest(`/roteiro/simulacao/${encodeURIComponent(String(id))}/public`),
    getSimulacaoSugestoes: (id: number | string): Promise<any[]> => apiRequest(`/roteiro/simulacao/${encodeURIComponent(String(id))}/sugestoes`),
    saveSimulacaoSugestao: (id: number | string, payload: any): Promise<{ success: boolean; id: number }> => apiRequest(`/roteiro/simulacao/${encodeURIComponent(String(id))}/sugestoes`, 'POST', payload),
...
const MockService = {
    ...
    getSimulacaoPublica: async (id: number | string) => null,
    getSimulacaoSugestoes: async (id: number | string) => [],
