                                                ...
                                                <div className="flex flex-col md:flex-row md:items-center justify-between gap-2 mb-2 pb-2 border-b border-slate-200/80 dark:border-slate-700/80">
                                                    <div className="flex items-center gap-2 flex-wrap">
                                                        ...
                                                        <span className={`text-[10px] font-bold px-2 py-0.5 rounded-full uppercase tracking-wider ${
                                                            ...
                                                            sug.TipoAjuste === 'HORARIO_ESPECIFICO' ? 'bg-cyan-100 text-cyan-700 dark:bg-cyan-900/40 dark:text-cyan-300' :
                                                            sug.TipoAjuste === 'CLIENTE_EXCLUSIVO' || sug.TipoAjuste === 'DIA_ESPECIFICO' ? 'bg-amber-100 text-amber-700 dark:bg-amber-900/40 dark:text-amber-300' :
                                                            'bg-slate-100 text-slate-700 dark:bg-slate-800 dark:text-slate-300'
                                                        }`}>
                                                            {sug.TipoAjuste === 'MUDANCA_DIA' ? 'Mudança de Dia' :
                                                             sug.TipoAjuste === 'MUDANCA_SEMANA' ? 'Mudança de Semana' :
                                                             sug.TipoAjuste === 'HORARIO_ESPECIFICO' ? 'Horário Específico' :
                                                             sug.TipoAjuste === 'CLIENTE_EXCLUSIVO' || sug.TipoAjuste === 'DIA_ESPECIFICO' ? 'Dia Específico' : sug.TipoAjuste || 'Geral'}
                                                        </span>
                                                    </div>
