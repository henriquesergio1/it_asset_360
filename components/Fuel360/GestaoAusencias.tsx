            ...
            <div className="bg-white dark:bg-slate-900 rounded-2xl p-5 shadow-sm border border-slate-200 dark:border-slate-800 flex flex-col md:flex-row gap-4 items-center justify-between">
                ...
                <div className="flex flex-wrap items-center gap-2 shrink-0">
                    ...
                    <button 
                        ...
                        className="bg-blue-600 hover:bg-blue-700 text-white font-bold py-2.5 px-4 rounded-xl flex items-center text-xs whitespace-nowrap shadow-lg shadow-blue-600/20 transition hover:-translate-y-0.5 active:scale-95"
                    >
                        <PlusCircleIcon className="w-4 h-4 mr-2" /> Nova Ausência
                    </button>
                </div>
            </div>
