...
// Logo Bomba de Combustível - Redesigned for Corporate Blue
export const FuelLogo: React.FC<IconProps> = ({ className = 'w-10 h-10' }) => (
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 100 100" className={className} fill="none">
    ...
    {/* Base */}
    <rect x="25" y="85" width="50" height="8" rx="2" fill="#1e293b" />
    {/* Body */}
    <rect x="30" y="20" width="40" height="65" rx="4" fill="url(#blueGradient)" />
    {/* Screen */}
    <rect x="38" y="30" width="24" height="15" rx="2" fill="white" opacity="0.9" />
    {/* Hose */}
    <path d="M70 40 C 85 40, 85 75, 70 75" stroke="#475569" strokeWidth="6" strokeLinecap="round" fill="none" />
    {/* Nozzle */}
    <rect x="70" y="35" width="12" height="10" rx="2" fill="#475569" />
    <path d="M76 35 L 76 25 L 82 20" stroke="#475569" strokeWidth="4" strokeLinecap="round" fill="none" />
    {/* Drop Detail */}
    <path d="M50 55 Q60 75 50 82 Q40 75 50 55 Z" fill="white" opacity="0.3" />
  </svg>
);

export const Frete360Logo: React.FC<IconProps> = ({ className = 'w-10 h-10' }) => (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 100 100" className={className} fill="none">
      <path d="M20 50 L50 20 L80 50 L50 80 Z" stroke="currentColor" strokeWidth="8" fill="none" />
...
export const DropIcon: React.FC<IconProps> = ({ className = 'w-6 h-6' }) => (
    <svg xmlns="http://www.w3.org/2000/svg" className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
...
export const MotoIcon: React.FC<IconProps> = ({ className = 'w-6 h-6' }) => (
    <svg xmlns="http://www.w3.org/2000/svg" className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
...
// MapWithMagnifyingGlass Icon for "Previsto vs Realizado"
...
export const ArrowsCompressIcon: React.FC<IconProps> = ({ className = 'w-6 h-6' }) => (
    <svg xmlns="http://www.w3.org/2000/svg" className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M9 9L4 4m0 0v4m0-4h4m6 5l5-5m0 0v4m0-4h-4m-7 11l-5 5m0 0v-4m0 4h4m11-5l-5 5m5 0v-4m0 4h-4" />
    </svg>
);
