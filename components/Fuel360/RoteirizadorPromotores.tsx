                ...
                <div className="p-6 space-y-5">
                    ...
                    <div>
                        ...
                        <input
                            ...
                            placeholder="Ex: Ajuste Fator 1.3, Rota Promotores, etc."
                            disabled={isSaving}
                                            ...
                                            {p.mapIndex === 0 && !p.isExcluded && (
                                                <div className="flex items-center gap-3 mb-2">
                                                    ...
                                                    <div>
                                                        ...
                                                        <p className="text-[11px] font-bold text-slate-500 lowercase mt-0.5">{(p.Grupo || 'promotor').toLowerCase()} - {p.CodigoSetor || p.Cod_Vend || p.ID_Pulsus}</p>
                                                    </div>
                                                </div>
                                            )}
                                            {p.mapIndex !== 0 && (
...
export const RoteirizadorPromotores: React.FC = () => {
    ...
    const handleOpenSaveModal = async () => {
        ...
        if (sellersToSave.length === 0) {
            alert("Nenhum promotor selecionado para salvar.");
            return;
        }
