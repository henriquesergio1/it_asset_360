...
const SystemInfoModal: React.FC<SystemInfoModalProps> = ({ onClose }) => {
 ...
 <span className={`px-2 py-0.5 rounded text-xs font-bold border ${index === 0 ? ' text-white border-blue-600' : ' bg-slate-800 border-slate-300 dark:border-slate-600'}`}>v{ver.version}</span>
 ...
 <div className="bg-slate-800 border-t border-slate-300 dark:border-slate-600 px-8 py-4 text-center"><p className="text-xs">© 2025 IT Asset 360. Todos os direitos reservados.</p></div>
 </div>
 </div>
 );
};
