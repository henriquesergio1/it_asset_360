            ...
            <div className="space-y-6">
                <div className="flex gap-4">
                    {(['USERS', 'DEVICES', 'SIMS'] as ImportType[]).map(t => (
                        <button key={t} onClick={() => setImportType(t)} className={`flex-1 py-5 border rounded-2xl flex flex-col items-center gap-2 transition-all ${importType === t ? 'border-blue-500 bg-blue-50 dark:bg-blue-900 text-blue-700 dark:text-blue-400 shadow-md scale-[1.02]' : 'hover:bg-gray-50 dark:hover:bg-slate-800 dark:border-slate-700 text-gray-500 dark:text-slate-500'}`}>
