...
const DataImporter = () => {
 ...
 <p className="text-[11px] text-center max-w-md italic">
 ...
 <th className="px-6 py-4 font-black uppercase tracking-widest">Resumo / Erro</th>
 </tr>
 </thead>
 <tbody>
 ...
 <td className="px-6 py-3 font-bold uppercase text-[10px]">
 {item.status === 'ERROR' ? (
 <span className="text-red-400 flex items-center gap-1"><AlertCircle size={12}/> {item.errorMsg}</span>
 ) : (
