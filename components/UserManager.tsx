...
const UserManager = () => {
 ...
 const pisDigits = (data.pis || '').replace(/\D/g, '');
 if (pisDigits && pisDigits.length !== 11) {
   return `O PIS / PASEP deve conter exatamente 11 dígitos. (Atual: ${pisDigits.length})`;
 }
