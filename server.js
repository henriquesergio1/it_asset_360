...
// --- BOOTSTRAP ENDPOINT (v2.12.44 - Completo) ---
...
// --- SYNC ENDPOINT (v2.12.44 - Lightweight) ---
...
app.post('/api/operations/checkout', async (req, res) => {
    try {
        ...
        if (assetType === 'Device' && prev) {
            ...
            // v2.12.44: Snapshotting completo no log para identificação infalível
...
app.listen(PORT, () => {
    console.log(`🚀 Servidor v2.12.44 rodando na porta ${PORT}`);
});
