...
// ... (código das rotas movido para dentro de startServer)
    ...
    app.post('/api/system/geocode', handleGeocodeRequest);
    app.post('/api/fuel360/system/geocode', handleGeocodeRequest);
    app.post('/api/fuel360/geocode', handleGeocodeRequest);
